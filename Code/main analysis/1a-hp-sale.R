rm(list=ls())
setwd("/Users/patie/Library/Mobile Documents/com~apple~CloudDocs/Master-Economics/Thesis/Coding/datasets/Source/RedX/house-sales")
library(data.table)
library(dplyr)
library(foreign)
library(ggplot2)
...
#data cleaning 
#########################################
# remove irrelevant variables (for all apartments for sale/rent and houses)
# remove freiab, courtage,  because of free form field
...
#eliminate all row entries where important values are marked as invalid by RWI
...
# some more transformations according to RWI price index
...
# changing structure to be similar to data description provided by authors
...
# preparation of coordinates for distance calculation
