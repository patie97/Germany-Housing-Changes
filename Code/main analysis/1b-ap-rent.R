rm(list=ls())
setwd("/Source/RedX/apartment-rents")
library(data.table)
library(dplyr)
library(foreign)
library(ggplot2)
...
#data cleaning 
#########################################
# remove irrelevant variables (for all apartments for rent and houses)
...
##########################################################
#data preparation so that binary variables are like price index
#########################################################
...
# Preparation for calculation of distances
